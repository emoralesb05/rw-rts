# Realmkeeper - Historical Vision Decisions

Archived long-form vision and decision record. The current concise north star
lives in [`../vision.md`](../vision.md).

This file preserves the original Q1-Q44 decisions, phase notes, backlog, and
known-gap context for reference. Treat current architecture and provider docs as
authoritative when they conflict with this archive.

---

# Original Vision & Open Questions
