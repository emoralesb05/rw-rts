...
function UnitLine({ unit }: { unit: UnitState }) {
  ...
  return (
    <button
      ...
      onClick={openWielder}
      aria-label={`Open ${unit.displayName} status`}
    >
      <img
...
export function WorldCommandHUD() {
  ...
  return (
    <section
      className={cn(
        "z-hud pointer-events-auto absolute bottom-[168px] left-1/2 flex w-[min(620px,calc(100vw-720px))] min-w-[500px] -translate-x-1/2 flex-col overflow-hidden rounded-md",
        "border-accent-alt/25 font-ui border bg-[#071025]/72 shadow-[0_18px_56px_rgba(0,0,0,0.46)] backdrop-blur-md",
        "max-xl:right-[348px] max-xl:left-[348px] max-xl:w-auto max-xl:min-w-0 max-xl:translate-x-0",
        "max-lg:right-3 max-lg:bottom-[156px] max-lg:left-3",
        "max-md:bottom-[156px]"
      )}
    ...
    >
      ...
      <div className="grid min-h-0 grid-cols-[1fr_210px] gap-2 p-2.5 max-md:grid-cols-1">
