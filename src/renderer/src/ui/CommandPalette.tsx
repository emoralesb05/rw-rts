    ...
    const items: CommandItem[] = [
      {
        ...
        detail: "Spawn Claude, Cursor, or Codex into a repo",
        keywords: "spawn dispatch claude cursor codex",
      ...
      },
      {
        ...
        detail: "Hook bridge installers, socket paths, provider health",
        keywords: "hooks connection provider bridge claude cursor codex",
